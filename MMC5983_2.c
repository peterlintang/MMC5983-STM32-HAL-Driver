...
void set_Internal_Control_0(void)
{
    ...
    write_onebuff_5983(INTERNAL_CTRL0 , reg_data);
}
...
{
    uint8_t reg_data = RS_4MS_200Hz;
    write_onebuff_5983(INTERNAL_CTRL1 , reg_data);
}

void set_Internal_Control_2(void)
{
    uint8_t reg_data = (CM_FREQ_200Hz|CMM_EN_CONTINUS|PRD_SET_1TIMES);
    write_onebuff_5983(INTERNAL_CTRL2 , reg_data);   
}
